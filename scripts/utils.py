...
import pandas as pd
from scripts.config import G37_FASTAS_DIR
...
def get_nucleotides_in_interval(chrom, start, end):
    ...
    file_path = f"{G37_FASTAS_DIR}/Homo_sapiens.GRCh37.dna.chromosome.{chrom}.fa"
...
@lru_cache(maxsize=None)
def get_downstream_sequence(chrom, pos, ref="T", n=30):
    """
